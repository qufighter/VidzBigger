...
//			prHTM+='</div>';//end layout hider div
  ...
  binfo+=unwin.preferencesToString();
	...
	for( i in sites ){
		prHTM+='<a href="'+sites[i]+'"><img src="'+sites[i]+'/favicon.ico" title="'+i+'" /></a> ';//
	}
...
unwin.p_getQuestionMarkImage=function(altTip){return '<a href="javascript:void(0);" style="position:absolute;right:5px;top:4px;"><img border="0" align="bottom" onclick="alert(\''+altTip+'\');" src="'+unwin.p_getQuestionMarkImageData()+'" alt="?"></a>';}
